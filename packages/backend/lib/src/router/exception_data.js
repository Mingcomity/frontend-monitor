...
import { reg_addexceptionData_schema, req_queryRecentExceptionData_schema, req_queryexceptionData_schema, } from '../schema/exception_data.js';
const router = express.Router();
// 添加异常数据
router.post('/', expressJoi(reg_addexceptionData_schema), exceptionDataHandler.addexceptionData);
// 查询异常数据
router.get('/', [
