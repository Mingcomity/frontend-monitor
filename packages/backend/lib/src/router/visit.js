...
import { reg_addVisit_schema, req_addstay_schema, req_queryPopularPv, req_queryPopularUv, req_queryVisit_schema, req_queryall, req_querystay_schema, } from '../schema/visit.js';
const router = express.Router();
// 用户页面访问
router.post('/visit', expressJoi(reg_addVisit_schema), pageVisitHandler.addVisit);
// 查询访问记录PV
router.get('/visit/pv', [
