...
import { reg_addProject_schema, req_alterProject_schema, } from '../schema/project.js';
...
// 获取项目信息
router.get('/', [expressJWt({ secret: config.jwtSecreKey, algorithms: ['HS256'] })], projectHandler.queryProject);
// 修改项目信息
router.put('/', [
    expressJWt({ secret: config.jwtSecreKey, algorithms: ['HS256'] }),
