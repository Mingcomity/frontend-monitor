...
import { reg_addperfData_schema, req_querySegPerf_schema, req_queryperfData_schema, } from '../schema/perf_data.js';
const router = express.Router();
// 添加性能数据
router.post('/', expressJoi(reg_addperfData_schema), perfDataHandler.addperfData);
// 查询性能数据
router.get('/', [
...
//# sourceMappingURL=perf_data.js.map