...
// 用户行为路由模块
import pageRouter from './src/router/visit'

// 性能数据路由模块
import perfRouter from './src/router/perf_data'

// 异常数据路由模块
import exceptionRouter from './src/router/exception_data'
...
// 错误中间件
app.use((err: any, req: any, res: any, _next: any): any => {
  // 数据验证错误
